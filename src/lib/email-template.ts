    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:540px;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 8px 40px rgba(0,0,0,.07)">
        ...
        <tr><td style="background:linear-gradient(135deg,${accent},${accent}cc);padding:44px 32px 38px;text-align:center;position:relative">
          ...
          <span style="position:absolute;top:35px;left:38%;width:5px;height:5px;background:#e879f9;border-radius:50%;animation:confetti2 2.3s ease-out infinite .5s"></span>
          <span style="position:absolute;top:5px;left:60%;width:4px;height:4px;background:#fcd34d;border-radius:50%;animation:confetti1 2.7s ease-out infinite 1.1s"></span>
